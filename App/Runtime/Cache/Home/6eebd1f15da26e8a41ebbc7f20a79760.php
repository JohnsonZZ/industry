	...
	<div class="bg-wrap mt10"> 
        <div class="main-content fl">
            ...
            <div id="upgrade-company-news" class="main-news">
            	<ul>
					<?php if(is_array($newsList)): $i = 0; $__LIST__ = $newsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Home/Industry/info/id/'.$news['id']);?>"><?php echo (msubstr($news["title"],0,15,'utf-8')); ?></a><span><?php echo ($news["time"]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        </div>
            ...
            <dl >
                <dt>
                     ...
                     <div class="ztlistarea-left">
                            <img src="/industry/Public/images/logo.jpg" width="100" height="100" /></div>
