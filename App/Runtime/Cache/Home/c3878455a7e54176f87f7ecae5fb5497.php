...
<div class="header">
    ...
    <!--网页头部代码结束-->
	<a href="<?php echo ($flash["url"]); ?>"> <img src="/industry<?php echo ($flash["pic"]); ?>" class="img-responsive" alt="Responsive image"/></a>
	<div class="bg-wrap mt10">
	<?php if(is_array($data)): foreach($data as $key=>$data): ?><div class="product">
			<div class="product-img">
                <a href="<?php echo U('Home/Design/info/aid/'.$data['aid']);?>"><img src="/industry<?php echo ($data["thumbnail"]); ?>" class="img-responsive-thumbnail"/></a>
			</div>
			<div class="product-brief">
				<div class="mt10">
					<a href="<?php echo U('Home/Design/info/aid/'.$data['aid']);?>" class="mr20"><?php echo ($data["title"]); ?></a>
					<span class="glyphicon glyphicon-eye-open mr5"></span>8888
				</div>
			</div>
